		...
		date_default_timezone_set(get_option('timezone_string')); 
			...
			else
			{
				...
				//$wpdb->query('BEGIN');
					...
					$content=$wpdb->escape($_POST['np_content']);
					$update_sql.=" content='$content' ,";
					$title=$wpdb->escape($_POST['np_title']);
...
<tr>
    ...
    News / Announcement Content<br>
     <?php  the_editor("$newsresults->content", "np_content", "", false);?>
     <br>
...
<tr>
    ...
    <td>
    Title<br>
    <input name="np_title" value="<?php echo $newsresults->title; ?>" type="text" id="np_title" style="width:300px; padding:5px;">
     <br>
